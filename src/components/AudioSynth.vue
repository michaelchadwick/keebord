...
const wafPresets = [
  ...
  {
    text: "Bright Acoustic Piano: Piano",
    value: "Bright Acoustic Piano: Piano",
  },
  ...
  {
    text: "Celesta: Chromatic Percussion",
    value: "Celesta: Chromatic Percussion",
  },
  {
    text: "Glockenspiel: Chromatic Percussion",
    value: "Glockenspiel: Chromatic Percussion",
  },
  {
    text: "Music Box: Chromatic Percussion",
    value: "Music Box: Chromatic Percussion",
  },
  {
    text: "Vibraphone: Chromatic Percussion",
    value: "Vibraphone: Chromatic Percussion",
  },
  {
    text: "Marimba: Chromatic Percussion",
    value: "Marimba: Chromatic Percussion",
  },
  {
    text: "Xylophone: Chromatic Percussion",
    value: "Xylophone: Chromatic Percussion",
  },
  {
    text: "Tubular Bells: Chromatic Percussion",
    value: "Tubular Bells: Chromatic Percussion",
  },
  {
    text: "Dulcimer: Chromatic Percussion",
    value: "Dulcimer: Chromatic Percussion",
  },
  ...
  {
    text: "Acoustic Guitar (nylon): Guitar",
    value: "Acoustic Guitar (nylon): Guitar",
  },
  {
    text: "Acoustic Guitar (steel): Guitar",
    value: "Acoustic Guitar (steel): Guitar",
  },
  {
    text: "Electric Guitar (jazz): Guitar",
    value: "Electric Guitar (jazz): Guitar",
  },
  {
    text: "Electric Guitar (clean): Guitar",
    value: "Electric Guitar (clean): Guitar",
  },
  {
    text: "Electric Guitar (muted): Guitar",
    value: "Electric Guitar (muted): Guitar",
  },
  ...
  {
    text: "Electric Bass (finger): Bass",
    value: "Electric Bass (finger): Bass",
  },
  ...
  {
    text: "Lead 2 (sawtooth): Synth Lead",
    value: "Lead 2 (sawtooth): Synth Lead",
  },
  {
    text: "Lead 3 (calliope): Synth Lead",
    value: "Lead 3 (calliope): Synth Lead",
  },
  { text: "Lead 4 (chiff): Synth Lead", value: "Lead 4 (chiff): Synth Lead" },
  {
    text: "Lead 5 (charang): Synth Lead",
    value: "Lead 5 (charang): Synth Lead",
  },
  { text: "Lead 6 (voice): Synth Lead", value: "Lead 6 (voice): Synth Lead" },
  { text: "Lead 7 (fifths): Synth Lead", value: "Lead 7 (fifths): Synth Lead" },
  {
    text: "Lead 8 (bass + lead): Synth Lead",
    value: "Lead 8 (bass + lead): Synth Lead",
  },
  { text: "Pad 1 (new age): Synth Pad", value: "Pad 1 (new age): Synth Pad" },
  { text: "Pad 2 (warm): Synth Pad", value: "Pad 2 (warm): Synth Pad" },
  {
    text: "Pad 3 (polysynth): Synth Pad",
    value: "Pad 3 (polysynth): Synth Pad",
  },
  ...
  {
    text: "FX 2 (soundtrack): Synth Effects",
    value: "FX 2 (soundtrack): Synth Effects",
  },
  {
    text: "FX 3 (crystal): Synth Effects",
    value: "FX 3 (crystal): Synth Effects",
  },
  {
    text: "FX 4 (atmosphere): Synth Effects",
    value: "FX 4 (atmosphere): Synth Effects",
  },
  {
    text: "FX 5 (brightness): Synth Effects",
    value: "FX 5 (brightness): Synth Effects",
  },
  {
    text: "FX 6 (goblins): Synth Effects",
    value: "FX 6 (goblins): Synth Effects",
  },
  {
    text: "FX 7 (echoes): Synth Effects",
    value: "FX 7 (echoes): Synth Effects",
  },
  {
    text: "FX 8 (sci-fi): Synth Effects",
    value: "FX 8 (sci-fi): Synth Effects",
  },
  ...
  {
    text: "Guitar Fret Noise: Sound effects",
    value: "Guitar Fret Noise: Sound effects",
  },
  ...
  {
    text: "Telephone Ring: Sound effects",
    value: "Telephone Ring: Sound effects",
  },
...
const adsr = new ADSREnvelope({
  ...
  attackTime:
    parseFloat(nodeGroups.adsr.nodes.attackTime.currentValue).toFixed(1) || 0.1,
  // how long from peakLevel to sustainLevel
  decayTime:
    parseFloat(nodeGroups.adsr.nodes.decayTime.currentValue).toFixed(1) || 0.5,
  // how loud to keep it once sustaining
  sustainLevel:
    parseFloat(nodeGroups.adsr.nodes.sustainLevel.currentValue).toFixed(1) ||
    0.1,
  // how long to go from sustainLevel to silence
  releaseTime:
    parseFloat(nodeGroups.adsr.nodes.releaseTime.currentValue).toFixed(1) ||
    0.5,
...
const createSendChain = function () {
  ...
  if (
    ...
    nodeGroups.filters.nodes.delay.audioNode.connect(
      nodeGroups.filters.nodes.eqLow.audioNode,
    );
  }
  // masterGain->eqLow
  else if (
    nodeGroups.filters.nodes.delay.audioNode &&
    !nodeGroups.filters.nodes.delay.enabled
  ) {
    ...
    nodeGroups.output.nodes.masterGain.audioNode.connect(
      nodeGroups.filters.nodes.eqLow.audioNode,
    );
  }
  // masterGain->eqLow
...
const createMasterChain = function () {
  ...
  // 3-band EQ
  nodeGroups.filters.nodes.eqLow.audioNode = createEQNode(
    "lowshelf",
    35,
    0,
    0.5,
  ...
  nodeGroups.filters.nodes.eqHigh.audioNode = createEQNode(
    "highshelf",
    4700,
    0,
    0.5,
  ...
  nodeGroups.filters.nodes.eqLow.audioNode.connect(
    nodeGroups.filters.nodes.eqMid.audioNode,
  );
  nodeGroups.filters.nodes.eqMid.audioNode.connect(
    nodeGroups.filters.nodes.eqHigh.audioNode,
  );
  nodeGroups.filters.nodes.eqHigh.audioNode.connect(
    nodeGroups.filters.nodes.compressor.audioNode,
  );
  ...
  if (audioContext.createStereoPanner && nodeGroups.output.nodes.pan) {
    ...
    nodeGroups.filters.nodes.compressor.audioNode.connect(
      nodeGroups.output.nodes.pan.audioNode,
    );
...
const controlValueChanged = function (controlGroup, controlName, newValue) {
  ...
  // otherwise, it's a gain modifier, most likely
    ...
    if (nodeControl.type == "range") {
      if (
        newValue <= parseFloat(nodeControl.max) &&
        newValue >= parseFloat(nodeControl.min)
      ) {
        ...
        kbSettings.value.controls[controlName] =
...
const toggleSynthControls = function () {
  kbSettings.value.global.showSynthControls =
    !kbSettings.value.global.showSynthControls;
...
const _setSynthControlDisplay = function () {
  let synthControlsContainer = document.getElementById(
    "synth-controls-container",
  );

  if (kbSettings.value.global.showSynthControls) {
    document.getElementById("toggle-synth-controls").src =
      "/assets/svg/bi-caret-down-fill.svg";

    synthControlsContainer.style.display = "flex";
  } else {
    document.getElementById("toggle-synth-controls").src =
      "/assets/svg/bi-caret-right-fill.svg";
...
const noteStart = function (noteNum, velocity = 64) {
  ...
  // update UI
  const domKey = document.querySelectorAll(
    `button[data-noteid='${noteNum}']`,
  )[0];
  if (domKey) {
  ...
  envelope.peakLevel =
    (velocity / 127) *
    parseFloat(nodeGroups.output.nodes.masterGain.currentValue);
...
const createOscNode = function (noteNum, startTime, envelope) {
  if (!oscNotes[noteNum]) {
    ...
    const noteFreq = parseFloat(
      MUSICAL_NOTES.filter((n) => n.midi == noteNum)[0].frequency,
    );

    // set oscillator wave type
    oscType =
      document.getElementById("osc-type").options[
        document.getElementById("osc-type").selectedIndex
      ].value;
...
const createSF2Node = function (noteNum, startTime) {
  ...
  const presetObj = sf2Presets.value.filter(
    (preset) => preset.header.name == curPresetValue,
  )[0];
...
const pitchBend = function (velocity) {
  ...
  let pbCents =
    ((pbRaw - inMin) * (outMax - outMin)) / (inMax - inMin) + outMin;
...
const _initSF2 = () => {
  ...
  loadSoundfont(
    `/assets/sf2/${nodeGroups.output.nodes.sf2Source.currentValue}.sf2`,
  ).then((player) => {
    let options = [];
    ...
    if (
      Object.values(options).find(
        (preset) => preset.text == kbSettings.value.controls.sf2Preset,
      )
    ) {
      nodeGroups.output.nodes.sf2Preset.currentValue =
        kbSettings.value.controls.sf2Preset;
    } else {
    ...
    switch (noteCount) {
      ...
      case 4:
        ...
        if (_arraysAreEqual([intval1, intval2, intval3], INTERVALS["dom7"])) {
          ...
          _arraysAreEqual([intval1, intval2, intval3], INTERVALS["maj7"])
        ) {
          chordName = `${_midi2Name(midiNums[0])}maj7`;
        } else if (
          _arraysAreEqual([intval1, intval2, intval3], INTERVALS["maj9"])
        ) {
          chordName = `${_midi2Name(midiNums[0])}maj9`;
        } else if (
          _arraysAreEqual([intval1, intval2, intval3], INTERVALS["7sus4"])
        ) {
          chordName = `${_midi2Name(midiNums[0])}7sus4`;
        } else if (
          _arraysAreEqual([intval1, intval2, intval3], INTERVALS["9sus4"])
        ) {
