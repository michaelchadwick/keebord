  ...
  >
    <legend>
      <input
        ...
        @change="$emit('checkEnabledChanged',
          props.controlGroup,
          props.controlKey,
    ...
    <div class="node-values">
      ...
      <template v-if="props.controlData.type == 'select'">
        <div class="value-container">
          <select
            ...
            @change="$emit('selectOptionChanged',
              props.controlGroup,
              props.controlKey,
              $event.target.value
            )"
      ...
      <template v-if="props.controlData.type == 'number'">
        <div class="value-container">
          <input
            ...
            :value="props.controlData.currentValue"
            :disabled="!props.controlData.enabled"
            @change="$emit('controlValueChanged',
              props.controlGroup,
              props.controlKey,
              $event.target.value
            )"
      ...
      <template v-if="props.controlData.type == 'range'">
        ...
        <input
          ...
          :value="props.controlData.currentValue"
          :disabled="!props.controlData.enabled"
          @input="$emit('controlValueChanged',
            props.controlGroup,
            props.controlKey,
            $event.target.value
          )"
    ...
    .node-control .node-values .value-container {
      ...
      .node-control .node-values .value-container .increase-decrease-container {
        ...
        .node-control .node-values .value-container .increase-decrease-container .control-value-decrease {
          ...
          .node-control .node-values .value-container .increase-decrease-container .control-value-increase:disabled,
          .node-control .node-values .value-container .increase-decrease-container .control-value-decrease:disabled {
            cursor: default;
            filter: invert(100%) sepia(1%) saturate(1895%) hue-rotate(235deg) brightness(111%) contrast(60%);
          }
          .node-control .node-values .value-container .increase-decrease-container .control-value-increase img,
          .node-control .node-values .value-container .increase-decrease-container .control-value-decrease img {
            filter: none;
            height: 16px;
            left: 0.09rem;
            margin: 0;
